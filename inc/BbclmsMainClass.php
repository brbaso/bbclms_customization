...
if ( !class_exists( 'BbclmsBPMainClass' ) ):
	...
	class BbclmsMainClass {
		...
		private $includes = [ 'BbclmsDB', 'BbclmsLoader' ];

		private $admin_includes = [ 'BbclmsAdminPage', 'BbclmsFileUploadSettingsPage' ];

		private $partials = [ 'BbclmsAdminView', 'BbclmsFileUploadSettingsAdminView' ];
